...
[] 2. Add functionality for adding tanks
    ...
    - liter_capacity: number that is typable
    - water_type: is a selection between saltwater and freshwater
    - temperature shall be a range
    - planted: boolean

[] 3. Add functionality for adding inhabitants

[] 4. Add fish wish list
